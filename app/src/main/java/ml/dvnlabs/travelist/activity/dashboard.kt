...
import ml.dvnlabs.travelist.fragment.About
...
class DashboardActivity : AppCompatActivity(){
    ...
    var fragCont : FrameLayout? = null
    var homeCont : RelativeLayout? = null
    var models : ArrayList<TravelModelList>? = ArrayList()

    private val mOnNavigationItemSelectedListener = BottomNavigationView.OnNavigationItemSelectedListener { item->
        when(item.itemId){
            R.id.bottom_home ->{
                closeFragment(supportFragmentManager.findFragmentById(R.id.fragment_container)!!)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        homeCont = findViewById(R.id.home_container)
    ...
    private fun modelsAdd(){
        ...
        models!!.add(TravelModelList(6,"Arashiyama","Arashiyama is a district on the western outskirts of Kyoto, Japan. It also refers to the mountain across the Ōi River, which forms a backdrop to the district. Arashiyama is a nationally designated Historic Site and Place of Scenic Beauty.",imgurimg+"arashiyama.jpg","Arashiyama,Ukyo Ward, Kyoto, 616-0007, Japan"))
        ...
        models!!.add(TravelModelList(8,"Akiu Great Falls","Akiu Great Falls (秋保大滝 Akiu Ōtaki) are located in Sendai, Miyagi Prefecture, Japan. They are a nationally designated Place of Scenic Beauty",imgurimg+"akiu.jpg","Akiu,Taihaku-ku, Sendai, Miyagi Prefecture, Japan"))
